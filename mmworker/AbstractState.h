...
public:
    ...
    */
    ...
    void set_mass_fractions_double(const std::vector<double> &mass_fractions){ set_mass_fractions(std::vector<CoolPropDbl>(mass_fractions.begin(), mass_fractions.end())); };
    #endif
